...
Instead of building dashboards focused only on metrics, this project focuses on decision intelligence: transforming data into actionable business recommendations.
...
- detect revenue and margin risks
...
- Which indicators represent business risk or opportunity?


# Solution Architecture

The project uses a modern analytics architecture based on AWS and Power BI.

## Components
- Amazon S3 --> data lake storage
- AWS Glue --> metadata catalog
- Amazon Athena --> SQL analytics layer
...
- Separation of raw, processed, and curated data
- Metadata managment
